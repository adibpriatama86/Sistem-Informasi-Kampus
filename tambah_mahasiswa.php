        ...
        <form id="form_mahasiswa" action="tambah_mahasiswa.php" method="post">
            <fieldset>
                ...
                <p>
                    ...
                    <input type="text" name="nim" id="nim" value="<?php echo $nim ?>" placeholder="Contoh: 12345678">
                    (8 digit angka)
                </p>
                <p>
                ...
                <p>
                    ...
                    <select name="tgl" id="tgl">
                        <?php
                        for ($i = 1; $i <= 31; $i++) {
                            echo "<option value=\"$i\"" . ($i == $tgl ? " selected" : "") . ">" . str_pad($i, 2, "0", STR_PAD_LEFT) . "</option>";
                        }
                        ?>
                    </select>
                    <select name="bln" id="bln">
                        ...
                        foreach ($arr_bln as $key => $value) {
                            echo "<option value=\"$key\"" . ($key == $bln ? " selected" : "") . ">$value</option>";
                        }
                        ?>
                    </select>
                    <select name="thn" id="thn">
                        <?php
                        for ($i = 1990; $i <= 2005; $i++) {
                            echo "<option value=\"$i\"" . ($i == $thn ? " selected" : "") . ">$i</option>";
                        }
                        ?>
                    </select>
                </p>
